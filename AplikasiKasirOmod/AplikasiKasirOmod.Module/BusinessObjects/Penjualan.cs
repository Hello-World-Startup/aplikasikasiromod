...
namespace AplikasiKasirOmod.Module.BusinessObjects
{
    ...
    public class Penjualan : XPObject
    { 
        public Penjualan(Session session)
            : base(session)
        {
        }
        ...
        [Association("Penjualan-DetailPenjualan",typeof(DetailPenjualan))]
        [DevExpress.Xpo.Aggregated]
        public XPCollection<DetailPenjualan> DetailPenjualan
        {
            get
            {
                return GetCollection<DetailPenjualan>("DetailPenjualan");
            }
        }
        #endregion
        ...
        {
            int x = 0;
            return x = Convert.ToInt32(Session.Evaluate<Penjualan>(DevExpress.Data.Filtering.CriteriaOperator.Parse("Max(Oid)"), null)) + 1;
        }
        #endregion
